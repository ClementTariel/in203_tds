...
void simulation(bool affiche)
{
    ...
    while (!quitting)
    {
        ...
        std::cout << "Temps calcul par etape (sans affichage) : " << elapsed_seconds.count() 
              << std::endl;
        ...
        std::cout << "Temps calcul par etape (avec affichage) : " << elapsed_seconds.count() + elapsed_seconds2.count() 
              << std::endl;
        std::cout << "Temps calcul par etape pour l'affichage : " << elapsed_seconds2.count() 
              << std::endl;
        std::cout << "Proportion du Temps calcul par etape pour l'affichage : " << elapsed_seconds2.count()/(elapsed_seconds.count() + elapsed_seconds2.count()) << std::endl;
